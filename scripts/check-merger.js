...
// Lê o e-mail de quem fez o merge no commit (padrão HEAD) e a lista "admins" de config/approvers.json.
...
const r = evaluate({ source, mergerEmail, admins: readJson('config', 'approvers.json').admins });
