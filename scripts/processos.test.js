...
const PROCESSOS = [
  ...
  ['Criar branch pela interface do Bitbucket', 'feature-flag', ['Create branch'], ['Create branch']],
  ...
  ['chore/* (só admin mescla)', 'feature-flag', ['só admin'], ['só admin']],
  ['Merge só pela pipeline', 'feature-flag', ['Mesclar o PR', 'merge-pr'], ['Mesclar o PR (depois de validar)']],
